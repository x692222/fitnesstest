        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <hr>
                    <div class="my-3">
                        <form action="/admin/products" method="post" class="mt-6">
                            {{ csrf_field() }}
                            <div class="flex justify-between gap-3">
                                ...
                                <span class="w-1/2">
                                  ...
                                  <input id="name" type="text" name="name" class="block w-full p-2 mt-2 text-gray-700 bg-gray-200 appearance-none" value="{{ old('name') }}" required />
                                    @if($errors->has('name'))
                                        <div class="text-red-900 text-sm font-bold">{{ $errors->first('name') }}</div>
                                    @endif
                                </span>
                                <span class="w-1/2">
                                  ...
                                  <input id="name" type="text" name="sku" class="block w-full p-2 mt-2 text-gray-700 bg-gray-200 appearance-none" value="{{ old('sku') }}" required />
                                    @if($errors->has('sku'))
                                ...
                                <span class="w-1/2">
                                  ...
                                  <input id="name" type="number" step="0.01" name="price" class="block w-full p-2 mt-2 text-gray-700 bg-gray-200 appearance-none" value="{{ old('price') }}" placeholder="1000.00" required />
                                    @if($errors->has('price'))
